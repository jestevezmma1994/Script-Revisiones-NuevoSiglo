...
#ifndef SOCIAL_MENU_CAROUSEL_H_
#define SOCIAL_MENU_CAROUSEL_H_

#include <SvFoundation/SvString.h>
#include <main_decl.h>
#include "Menus/carouselMenu.h"

typedef struct QBSocialMediaCarouselMenuItemController_t* QBSocialMediaCarouselMenuItemController;
typedef struct QBSocialMediaCarouselMenuItemService_ *QBSocialMediaCarouselMenuItemService;
