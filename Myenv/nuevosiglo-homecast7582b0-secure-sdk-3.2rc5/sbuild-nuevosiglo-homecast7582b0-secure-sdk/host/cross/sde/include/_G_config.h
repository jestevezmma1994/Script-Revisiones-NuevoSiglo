...
#ifndef _G_config_h
#define _G_config_h
#define _G_LIB_VERSION "2.8-mipssde-031117"
...
typedef short int _G_uint16_t;
typedef  int  _G_int32_t;
typedef int _G_uint32_t;
#endif

typedef unsigned long _G_clock_t;
typedef unsigned short int _G_dev_t;
typedef _G_llong _G_fpos_t;
typedef unsigned short int _G_gid_t;
typedef unsigned short int _G_ino_t;
typedef unsigned short int _G_mode_t;
typedef unsigned short int _G_nlink_t;
typedef _G_llong _G_off_t;
typedef short int _G_pid_t;
#ifndef __PTRDIFF_TYPE__
#define __PTRDIFF_TYPE__ long
#endif
typedef __PTRDIFF_TYPE__ _G_ptrdiff_t;
typedef _G_ullong _G_sigset_t;
#ifndef __SIZE_TYPE__
#define __SIZE_TYPE__ __typeof(sizeof(int))
#endif
typedef __SIZE_TYPE__ _G_size_t;
typedef long _G_time_t;
typedef unsigned short int _G_uid_t;
typedef short unsigned int _G_wchar_t;

#define _G_BUFSIZ 1024
#define _G_FOPEN_MAX 0x7fffffff
