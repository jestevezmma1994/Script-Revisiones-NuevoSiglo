...
/*
 * sys/select.h: kernel internals for select
 */
...
struct selinfo {
    ...
    struct selwait *	si_waiter;	/* waiting thread */
};
#define	SI_SEL	0x0001		/* select pending */
#define	SI_COLL	0x0001		/* collision occurred */

void	_selrecord (struct selinfo *);
void	_selwakeup (struct selinfo *);

#ifdef _KERNEL
#define selrecord(proc, sel)	_selrecord(sel)
#define selwakeup(sel)		_selwakeup(sel)
#endif
