...
#define PTHREAD_MUTEX_INITIALIZER \
  {{0},~0, \
   {PTHREAD_MUTEX_DEFAULT_NP, PTHREAD_PROCESS_PRIVATE, PTHREAD_PRIO_NONE}}

#define PTHREAD_FAST_MUTEX_INITIALIZER_NP \
  {{0},~0, \
   {PTHREAD_MUTEX_FAST_NP, PTHREAD_PROCESS_PRIVATE, PTHREAD_PRIO_NONE}}

#define PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP \
  {{0},~0, \
   {PTHREAD_MUTEX_RECURSIVE_NP, PTHREAD_PROCESS_PRIVATE, PTHREAD_PRIO_NONE}}

#define PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP \
  {{0},~0, \
   {PTHREAD_MUTEX_ERRORCHECK_NP, PTHREAD_PROCESS_PRIVATE, PTHREAD_PRIO_NONE}}
