...
#ifndef QB_CONAX_ACCESS_PLUGIN_H_
#define QB_CONAX_ACCESS_PLUGIN_H_

/**
 * @file ConaxAccessPlugin.h
...
/**
 * @defgroup ConaxAccessPlugin Smartcard-based access plugin class
 ...
 * @class ConaxAccessPlugin
 * @extends SvObject
 **/
typedef struct ConaxAccessPlugin_t *ConaxAccessPlugin;
 ...
 **/
extern SvType
ConaxAccessPlugin_getType(void);

/**
 * Initialize smartcard-based access plugin instance.
 *
 * @memberof ConaxAccessPlugin
 *
 * @param[in] self      smartcard-based access plugin handle
 * @param[in] netManager Network Manager instance
 * @param[in] timeout   in seconds, how long should an authentication be valid
 * @param[out] errorOut error info
 * @return              @a self or @c NULL in case of error
 **/
extern ConaxAccessPlugin
ConaxAccessPluginInit(ConaxAccessPlugin self,
