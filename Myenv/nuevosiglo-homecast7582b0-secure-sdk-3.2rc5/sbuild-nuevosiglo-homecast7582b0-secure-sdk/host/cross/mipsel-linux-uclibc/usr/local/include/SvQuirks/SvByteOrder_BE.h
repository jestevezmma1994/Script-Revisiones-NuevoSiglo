...
#ifndef SV_BYTE_ORDER__BIG_ENDIAN_H_
#define SV_BYTE_ORDER__BIG_ENDIAN_H_

#if defined SV_BYTE_ORDER_H_ && SV_BYTE_ORDER == SV_BIG_ENDIAN
...
// conversions between host and little-endian == byte swap
...
#endif // defined SV_BYTE_ORDER_H_ && SV_BYTE_ORDER == SV_BIG_ENDIAN

#endif // SV_BYTE_ORDER__BIG_ENDIAN_H_
