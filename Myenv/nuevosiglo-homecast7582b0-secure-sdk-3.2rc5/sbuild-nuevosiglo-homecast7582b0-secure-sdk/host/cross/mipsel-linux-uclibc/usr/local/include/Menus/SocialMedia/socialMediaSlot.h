...
#ifndef _MOVIE_INFO_SLOT_H_
#define _MOVIE_INFO_SLOT_H_

#include <CUIT/Core/types.h>
#include <SvFoundation/SvString.h>
#include <Services/core/QBTextRenderer.h>

typedef struct QBSocialMediaItemDetailsSlotController_t        *QBSocialMediaItemDetailsSlotController;
typedef struct QBSocialMediaProfileSlotController_t *QBSocialMediaProfileSlotController;
typedef struct QBSocialMediaPictureSlotController_t         *QBSocialMediaPictureSlotController;
typedef struct QBSocialMediaGallerySlotController_t         *QBSocialMediaGallerySlotController;
