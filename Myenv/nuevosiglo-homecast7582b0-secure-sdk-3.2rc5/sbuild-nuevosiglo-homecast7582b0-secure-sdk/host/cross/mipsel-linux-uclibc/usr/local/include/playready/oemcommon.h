...
extern const DRM_CONST_STRING g_dstrDevId;
...
DRM_API DRM_RESULT DRM_CALL _GetDRMModelFullPathName( 
    __out DRM_WCHAR **f_ppwszFullPath, 
    __in_opt const DRM_CONST_STRING *f_pdstrFilename,
    __in DRMFILESPATH f_eFilesPath );
...
DRM_API DRM_RESULT DRM_CALL Oem_Device_SetUniqueId(
    __in_opt                             DRM_VOID            *f_pOEMContext,
    __in                                 const DRM_DEVICE_ID_TYPE   f_eIDType,
    __in_bcount(f_cbLength)             DRM_BYTE            *f_pbUniqueId,
    __in                                 DRM_DWORD           f_cbLength );
