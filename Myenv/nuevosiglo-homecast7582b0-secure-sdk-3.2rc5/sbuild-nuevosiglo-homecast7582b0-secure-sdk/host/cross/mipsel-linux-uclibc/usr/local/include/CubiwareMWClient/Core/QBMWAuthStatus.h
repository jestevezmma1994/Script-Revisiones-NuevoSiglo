...
#ifndef QB_WEB_AUTH_STATUS_H_
#define QB_WEB_AUTH_STATUS_H_

/**
 * @file QBMWAuthStatus.h
 * @brief Cubiware middleware authentication status type
 ...
 **/
typedef struct QBMWAuthStatus_ {
