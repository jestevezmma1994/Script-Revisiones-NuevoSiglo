...
#ifndef CAGE_BITMAP_PPM_IO_H_
#define CAGE_BITMAP_PPM_IO_H_

/**
 * @file SvBitmapPPMIO.h Bitmap PPM input/output API
 ...
 * @param[in] filePath  destination PPM file path
 * @param[out] errorOut error info
 **/
extern void
SvBitmapWriteToPPM(SvBitmap self,
