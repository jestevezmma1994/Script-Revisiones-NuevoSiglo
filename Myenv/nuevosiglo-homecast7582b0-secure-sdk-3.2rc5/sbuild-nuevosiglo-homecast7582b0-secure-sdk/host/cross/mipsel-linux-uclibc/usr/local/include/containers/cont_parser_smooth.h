...
#ifndef CONT_PARSER_SMOOTH_H_
#define CONT_PARSER_SMOOTH_H_
...
struct cont_parser_smooth_params
{
...
extern int
cont_parser_smooth_create(const struct cont_parser_smooth_params* params, struct cont_parser** out);
