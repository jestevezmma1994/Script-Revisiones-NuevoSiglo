...
#ifndef SV_PLAYER_TASK_RESTRICTIONS_H_
#define SV_PLAYER_TASK_RESTRICTIONS_H_

/**
 * @file SvPlayerTaskRestrictions.h Definition of the player task restrictions
