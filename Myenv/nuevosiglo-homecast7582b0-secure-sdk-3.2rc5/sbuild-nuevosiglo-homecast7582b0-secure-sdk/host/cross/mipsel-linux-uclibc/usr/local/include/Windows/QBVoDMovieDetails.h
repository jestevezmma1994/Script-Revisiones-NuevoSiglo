...
QBWindowContext
QBVoDMovieDetailsContextCreate(AppGlobals appGlobals, QBContentCategory category, SvDBRawObject movie, SvGenericObject provider, SvString serviceId, SvString serviceName, SvObject externalTree, SvString categoryName, SvString recomendedFrom);
//QBWindowContext
