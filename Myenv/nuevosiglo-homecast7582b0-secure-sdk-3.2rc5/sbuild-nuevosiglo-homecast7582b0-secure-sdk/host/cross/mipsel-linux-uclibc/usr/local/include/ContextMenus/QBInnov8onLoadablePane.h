...
// AMERELES [2986] Funcionalidad Mi Lista con agregar y quitar
/**
 * Start the fetch service to Add or Remove a product from Mi Lista.
 *
 * @param[in] self      this object
 * @param[in] product   product whose data needs to be fetched
 * @param[in] scheduler sheduler to use for transaction manager
 * @param[in] toAdd     add product to Mi Lista
 **/
void
...
void
QBInnov8onLoadablePaneInit(QBInnov8onLoadablePane self, QBContextMenu ctxMenu, AppGlobals appGlobals, SvString serviceID); // AMERELES [2986] Funcionalidad Mi Lista con agregar y quitar
