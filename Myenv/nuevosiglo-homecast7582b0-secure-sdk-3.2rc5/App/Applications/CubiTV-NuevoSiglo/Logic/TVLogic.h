...
/**
 * Callback del Pop-up que aparece al cambiar de canal cuando se está usando el time-shift
 *
 * @}
 **/
void QBTVLogicTimeShiftCancelPopUpCallback(QBTVLogic self, unsigned int event) __attribute__((weak)); // RAL TimeShift cancel pop-up window

/**
 * Configura el último evento de Control Remoto presionado
 *
 * @param[in] self TVLogic instance
 * @param[in] eventId uint16_t Evento de Control Remoto
 * @}
 */
