...
#ifndef QBTUNERLOGS_H_
#define QBTUNERLOGS_H_
...
void BoldQBTunerLogsSendTunerStatus(int number); // AMERELES #2529 Cambios en lógica de envío de reportes TUNER vía Syslog
