...
SvLocal void
QBConfigurationMenuRegisterUpdateVoDServicesMenu(SvWidget menu, QBTreePathMap pathMap, AppGlobals appGlobals)
{
    SvObject path = NULL;
    if (!QBActiveTreeFindNodeByID(appGlobals->menuTree, SVSTRING("UpdateVODServices"), &path))
        return;
...
// BEGIN AMERELES Estado de Canal donde estaba en SDK 1.0
SvLocal void
QBConfigurationMenuRegisterChannelStatusMenu(SvWidget menu, QBTreePathMap pathMap, AppGlobals appGlobals)
{
    SvObject path = NULL;
    if (!QBActiveTreeFindNodeByID(appGlobals->menuTree, SVSTRING("DiagnosticsChannelStatus"), &path))
        return;
...
// END AMERELES Estado de Canal donde estaba en SDK 1.0
...
QBConfigurationMenuRegisterMenus(SvWidget menu, QBTreePathMap pathMap, AppGlobals appGlobals)
{
    ...
    QBConfigurationMenuRegisterUpdateVoDServicesMenu(menu, pathMap, appGlobals); // AMERELES Update VoD Services
    QBConfigurationMenuRegisterChannelStatusMenu(menu, pathMap, appGlobals); // AMERELES Estado de Canal donde estaba en SDK 1.0
