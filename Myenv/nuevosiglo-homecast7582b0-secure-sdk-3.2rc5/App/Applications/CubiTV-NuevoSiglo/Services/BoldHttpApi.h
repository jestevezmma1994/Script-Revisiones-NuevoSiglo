...
#ifndef BoldHttpApi_H_
#define BoldHttpApi_H_

#include <SvFoundation/SvGenericObject.h>

#define HTTP_BUF_LEN 2048

typedef struct BoldHttpApi_t* BoldHttpApi;


typedef void (*BoldHttpApiCallback) (void * ptr, char * buff, size_t len);
...
BoldHttpApi BoldHttpApiStartRequest(BoldHttpApi self, const char *URL, const unsigned char* msg, void * callbackData, BoldHttpApiCallback f, SvErrorInfo *errorOut);
