...
#ifndef QBMIDDLEWAREBOOKMARK_H_
#define QBMIDDLEWAREBOOKMARK_H_

#include <SvFoundation/SvString.h>
#include <SvFoundation/SvType.h>
#include <SvCore/SvErrorInfo.h>

typedef struct QBMiddlewareBookmarkParams_
{
    SvString productId;
    SvString deviceId;
    SvString tag;
} QBMiddlewareBookmarkParams_t;

typedef struct QBMiddlewareBookmark_ *QBMiddlewareBookmark;
...
SvString
QBMiddlewareBookmarkGetProductId(QBMiddlewareBookmark self,
                                 SvErrorInfo *errorOut);
