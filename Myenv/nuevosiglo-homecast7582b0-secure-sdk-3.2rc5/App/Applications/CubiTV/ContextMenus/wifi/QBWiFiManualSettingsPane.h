...
#ifndef QB_WIFI_MANUAL_SETTINGS_PANE_H_
#define QB_WIFI_MANUAL_SETTINGS_PANE_H_

/**
 * @file QBWiFiManualSettingsPane.h WiFi Manual settings Pane API for QBNetworking2
...
/**
 * @defgroup QBWiFiManualSettingsPane QBWiFiManualSettingsPane for QBNetworking2
 * @ingroup CubiTV
 * @{
 **/

/**
 * Creates WiFi manual settings pane
 *
 ...
 * @param[in] wifiInterface     network interface for which the pane is created
 * @param[in] ctxMenu           context menu
 * @param[in] level             level on which the pane shall be shown
 * @return QBBasicPane handle with WiFi manual settings
  **/
QBBasicPane
...
#endif //QB_WIFI_MANUAL_SETTINGS_PANE_H_
