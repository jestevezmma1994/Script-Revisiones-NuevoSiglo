...
#ifndef QBCUSTOMERINFOSTORAGE_H_
#define QBCUSTOMERINFOSTORAGE_H_

#include <SvFoundation/SvString.h>
#include <main_decl.h>

typedef struct QBCustomerInfoStorage_t *QBCustomerInfoStorage;
...
#endif /* QBCUSTOMERINFOSTORAGE_H_ */
