...
static struct QBTimeFormat_t defaultFormat = {
    .PVRStartTime          = "%A / %d.%m.%Y, %H:%M",
    .PVRAvailableTime      = "%A / %d.%m.%Y",
    .reminderTime          = "%A / %d.%m.%Y, %H:%M",

    .gridEPGDate           = "%A / %d.%m.%Y",
    .verticalEPGDate       = "%A / %d.%m.%Y",
    .searchResultsDate     = "%d.%m.%Y",
