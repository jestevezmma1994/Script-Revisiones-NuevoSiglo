...
typedef struct QBHint_t* QBHint;
typedef struct QBHintDisplayer_t* QBHintDisplayer;
typedef struct QBHintManager_t* QBHintManager;

/**
 * Get runtime type identification object representing QBHintManager type.
 *
 * @return QBHintManager runtime type identification object
**/
SvType QBHintManager_getType(void);
void QBHintManagerLoadHints(QBHintManager self, SvString hintsDatabaseFilename);
void QBHintManagerAddHint(QBHintManager self, SvString hint);
