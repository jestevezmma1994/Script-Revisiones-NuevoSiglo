...
#ifndef QBTVCATEGORIESMENU_H
#define QBTVCATEGORIESMENU_H
...
/**
 * @defgroup QBTVCategoriesMenu TV channel menu
 * @ingroup CubiTV_menus
 * @{
 **/

/**
 * Register TV categories menu
 *
 ...
 * @param[in] rootID        name of root node to link categories menu
 */
