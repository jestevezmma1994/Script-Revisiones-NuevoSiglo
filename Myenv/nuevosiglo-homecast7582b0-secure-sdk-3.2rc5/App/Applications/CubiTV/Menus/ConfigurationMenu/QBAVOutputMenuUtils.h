...
#ifndef QB_AVOUTPUT_MENU_UTILS_H_
#define QB_AVOUTPUT_MENU_UTILS_H_
...
/**
 * @defgroup QBAVOutputMenuUtilites A/V Output menu utilities
 * @ingroup QBNewConfigurationMenu
 * @{
 */

/**
 * Check AVOutputMenu node tick state.
 *
...
#endif /* QB_AVOUTPUT_MENU_UTILS_H_ */
