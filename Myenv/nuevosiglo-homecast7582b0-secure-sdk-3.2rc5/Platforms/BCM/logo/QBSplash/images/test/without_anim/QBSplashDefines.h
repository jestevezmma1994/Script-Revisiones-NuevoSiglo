...
entry progress_bg = {QBSplashEntryType_bg, 1, PRIMARY_WIDTH / 2, 500, {"../full/progress_bg.png"}};
entry progress_bar = {QBSplashEntryType_bar, 1, PRIMARY_WIDTH / 2, 500, {"../full/progress_bar.png"}};
