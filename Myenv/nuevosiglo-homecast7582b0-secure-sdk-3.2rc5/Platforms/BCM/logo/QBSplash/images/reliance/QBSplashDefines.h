...
entry logo = {QBSplashEntryType_logo, 1, PRIMARY_WIDTH / 2, PRIMARY_HEIGHT / 2, {"logo_splash.png"}};
entry progress_bg = {QBSplashEntryType_bg, 1, PRIMARY_WIDTH / 2, 500, {"boot_screen_loader_bg.png"}};
entry progress_bar = {QBSplashEntryType_bar, 1, PRIMARY_WIDTH / 2, 500, {"boot_screen_loader_fill.png"}};
entry *entries[ENTRY_COUNT] = {&logo, &progress_bg, &progress_bar};
